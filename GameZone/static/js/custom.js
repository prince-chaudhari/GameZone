...
document.addEventListener('DOMContentLoaded', function () {
	// JavaScript code to handle card flipping functionality
	document.querySelectorAll('.info-icon').forEach(function (icon) {
		icon.addEventListener('click', function () {
			this.closest('.item').classList.toggle('flipped');
		});
	});

	document.querySelectorAll('.back-content').forEach(function (backContent) {
